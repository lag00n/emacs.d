...
(use-package god-mode
  ...
  :hook (post-command-hook lx-god-mode-update-cursor)
  
  :config
  (defun lx-god-mode-update-cursor ()
...
(defun lxgmacs/set-font-faces ()
  ...
  (set-face-attribute 'default nil :font "Sudo medium 14")
...
#+begin_src elisp 
(custom-set-faces
 	'(font-lock-comment-face ((t (:font "Sudo medium 14" :bold t :italic t)))))
#+end_src
